...
<Helmet>
  <title>천안아산역이편한세상시티 - 청약안내</title>
  <meta
    name="description"
    content="천안아산역이편한세상시티 청약안내를 한눈에 확인하세요. 특별공급·1·2순위 청약 일정, 자격요건, 필요서류와 인터넷 청약 절차를 안내합니다."
  />
  <link rel="canonical" href="https://www.layershop.kr/SalesInfo/SubscriptionGuide" />
...
<MenuBar contents={menuContents} />
      ...
      <div className={styles.textBox}>
        ...
        <div>천안아산역이편한세상시티, 기회를 놓치지 마세요</div>
      </div>

      <img
        className={`${styles.image2} ${isImage2Loaded ? styles.showImage2 : ''}`}
        src={page1}
        alt="천안아산역이편한세상시티- 청약안내문 -image1"
