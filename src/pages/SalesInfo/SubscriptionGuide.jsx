...
const ComplexGuide1 = () => {
  ...
  return (
    ...
    <Helmet>
      <title>천안아산역이편한세상시티 - 체크포인트</title>
      <meta
        name="description"
        content="천안아산역이편한세상시티 분양 전 필수 체크포인트를 확인하세요. 청약 자격(거주기간·무주택·예치금), 특별공급 유형, 필요서류·일정, 유의사항을 한눈에 안내합니다."
      />
    ...
    <p className={styles.screenReaderOnly}>
      천안아산역이편한세상시티 분양 전 확인해야 할 핵심 체크리스트입니다.
    ...
    <div className={styles.textBox}>
      ...
      {/* <img
        ...
        src={page1}
        alt="천안아산역이편한세상시티청약제도 변경안내 이미지1"
