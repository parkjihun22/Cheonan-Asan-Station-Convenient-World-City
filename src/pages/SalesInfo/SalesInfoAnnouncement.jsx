...
<Helmet>
  <title>두산위브 센트럴파크 강화 - 모집공고안내</title>
  <meta
    name="description"
    content="두산위브 센트럴파크 강화 모집공고를 한눈에 확인하세요. 공급 세대수·공급면적·분양가, 청약 일정·자격, 당첨자 발표·정당계약 및 유의사항을안내합니다."
  />
  <link rel="canonical" href="https://www.layershop.kr/SalesInfo/announcement" />
...
<h1 className={styles.screenReaderOnly}>
  두산위브 센트럴파크 강화 - 모집공고안내
</h1>
<p className={styles.screenReaderOnly}>
  본 페이지에서는 두산위브 센트럴파크 강화의 모집공고 주요 사항을안내합니다.
