...
const BusinessGuide2 = () => {
	...
	return (
		...
		<link
			rel="canonical"
			href="https://www.layershop.kr/BusinessGuide/documents"
		/>
		...
		<meta property="og:image:alt" content="천안아산역이편한세상시티 계약서류안내 페이지 대표 이미지" />
		...
		<div>계약서류, 지금부터 미리 준비하세요</div>
			...
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="천안아산역이편한세상시티계약서류안내-image1" /> */}
