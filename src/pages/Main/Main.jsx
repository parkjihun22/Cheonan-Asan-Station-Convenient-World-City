        ...
        <>
          ...
          <div className={styles.imageContainer}>
            <img
              ...
              alt="천안아산역이편한세상시티-mainimage1"
            />
            <div className={styles.overlay}></div>
            <div className={styles.mainImageTextBox}>
            <div className={styles.mainImageTextSub}>
            브랜드 신뢰 <strong>이편한세상</strong>{" "}
            <span className={styles.greyText}>하이엔드 프리미엄</span>
          </div>

          <div className={styles.mainImageTitleBox}>
            <div className={styles.mainImageText}>천안아산의 하이엔드 미래</div>
          ...
          <div className={styles.section}>
            <div className={styles.section2}>
              ...
              <img
                src={section2_Image1}
                alt="천안아산역이편한세상시티아파트 조감도-image3"
                loading="lazy"
                decoding="async"
              />
            </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="천안아산역이편한세상시티브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>천안아산역이편한세상시티</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://formspree.io/f/mojdoapw"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="천안아산역이편한세상시티오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="천안아산역이편한세상시티mobilemain-image1"
            />
            <div className={styles.overlay}></div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 천안아산역이편한세상시티에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="천안아산역이편한세상시티모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="천안아산역이편한세상시티브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="천안아산역이편한세상시티오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
